    ...
    if user_options["filter"] == 0:#remember to make "0" into 0
        filter = [{0: "score = ?",
                   ...
                   7: "score <= ?",
                     ...
                     ], four.validate("What do you want to compare to?", str)]#temp, will be comp 4 later. of which I am glad, because this is a hhhhaaaaaaaack. Oh, and don't forget to make "0" -> 0                                           
    query = "SELECT"
