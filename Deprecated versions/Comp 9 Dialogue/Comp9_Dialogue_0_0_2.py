"""
    ...
    Improvements over previous versions:
        Rather than the hard coded string format blunt single syllable response
        of the previous trial, this method should use a better, more responsive
        system. This will feature less obvious responses, and more complex use
        of evidence. It will also... actually work.
    Disadvantages as compared to previous versions and trials and whatnot:
        Harder to code
        Slower
"""
...
def display_dialogue(person, evidence, user):
    ...
    while dialogue_loop:  # dialogue loop
        ...
        if choice in ["a"]:  # leaving conversation
            ...
            evidence_choice = input()  # comp 4 here
            evidence_choice = evidence[int(evidence_choice)]#invalidanddangerousbutwillbefixedwithcomp4
            print(user, ":", sep="")  # print username
