...
def display_dialogue(person, evidence, user):
    ...
    Returns:
        None
    """
    print("You strike up a conversation with", person[0])  # uiiiiiii
    ...
    while dialogue_loop:  # dialogue loop
        ...
        if choice in ["a"]:  # leaving conversation
            ...
            for piece in range(len(evidence)):  # display the options
                print(piece+1, ": ", evidence[piece][0], sep="")  # display
            evidence_choice = four.validate("", int, convert=True, num_min=1,
