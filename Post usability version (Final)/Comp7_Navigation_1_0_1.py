...
def navigation(map, room):
    ...
    """
    option_number = 1  # this is just for numbering - for the options
    ...
    user_choice = four.validate("", int, convert=True, num_min=1,
                                num_max=len(map[room][1])+1)  # user input
    room = map[room][1][user_choice-1]  # move the user
